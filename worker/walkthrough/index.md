---
title: IronWorker Dashboard Walk-Through
layout: default
section: worker
breadcrumbs:
  - ['Hud', 'dash', 'dashboard', 'worker','Walk-Through']
---

When you first log into <a href="https://dash.iron.io">the Dashboard</a>, you'll be taken to the Dashboard. Here you'll see  list of your projects as well as a usage indicator on the right. Click the "Worker" button to the right of the project name to move forward.
