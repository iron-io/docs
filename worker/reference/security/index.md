...
<ol>
  <li>To retrieve the Private IP of your RDS resource navigate to your [https://console.aws.amazon.com](Amazon Web Services Console) and copy your public endpoint. <img width="100%" target="_blank" src="https://monosnap.com/image/6qEZ1C4NlyxUgbicSYDh5Z3qqxtcGW.png" alt=""> </li>
...
<p>When accessing Amazon EC2 resources again use the private ip address of your instances rather than the public DNS URL that amazon provides. EC2's dashboard makes accessing this ip simpler than the previous example.</p>
<ol>
